...
namespace DelaunayVoronoi
{
    ...
    {
        public DVPoint[] Vertices { get; } = new DVPoint[3];
        public DVPoint Circumcenter { get; private set; }
        ...
        public Triangle(DVPoint point1, DVPoint point2, DVPoint point3)
        {
        ...
        private void UpdateCircumcircle()
        {
            ...
            var center = new DVPoint(aux1 / div, aux2 / div);
            Circumcenter = center;
            RadiusSquared = (center.X - p0.X) * (center.X - p0.X) + (center.Y - p0.Y) * (center.Y - p0.Y);
        }

        private bool IsCounterClockwise(DVPoint point1, DVPoint point2, DVPoint point3)
        {
        ...
        public bool IsPointInsideCircumcircle(DVPoint point)
        {
